  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] mt-10 flex flex-wrap justify-center gap-4">
        <a
          href={GITHUB_REPO}
          className="flex cursor-pointer items-center gap-2 rounded-lg border-none bg-accent px-7 py-3 text-[1rem] font-semibold text-background no-underline transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_color-mix(in_srgb,var(--accent)_25%,transparent)]"
        >
